...
let opts = {
    ...
    secretOrKey : env.jwt_secret //this is encryption and decryption string//if i change it after generating a token i will not be able to decrypt that token back
